                                ...
                                <Row className='personaldata'>
                                    ...
                                    :
                                        ...
                                        <div className='topaddding'>
                                            ...
                                            <select className="nameinputselect"
                                            ...
                                            <label className='labelinput'>Choose a category</label>
                                        </div>
                                        <div className='topaddingcomp'>
                                            <input type='checkbox' onChange={e=>this.setState({cheked:!this.state.cheked})}/>
                                            <text className='texttoleft'>I accept the</text>&nbsp;<text className='terms' >Terms and Conditions</text>
                                        </div>
...
const style={ width: '100%',height:'35px',
// marginTop:'5px',
color:'#0A0909',outline:'none',fontWeight:'600'}
